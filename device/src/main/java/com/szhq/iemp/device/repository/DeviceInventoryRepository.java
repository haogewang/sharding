...
public interface DeviceInventoryRepository extends JpaRepository<TdeviceInventory, String>, JpaSpecificationExecutor<TdeviceInventory> {
    ...
    @Query(value = "select distinct(operator_id) from t_device_inventory where deliver_sn in (?1)", nativeQuery = true)
    ...
    @Query(value = "select * from t_device_inventory where box_number = ?1", nativeQuery = true)
     List<TdeviceInventory> findByBoxNumber(String boxNumber);

    @Query(value = "select * from t_device_inventory where box_number in (?1)", nativeQuery = true)
     List<TdeviceInventory> findByBoxNumberIn(List<String> boxNumbers);

    @Query(value = "select distinct (box_number) from t_device_inventory where deliver_sn in (?1)", nativeQuery = true)
    List<String> findBoxNumbersByDeliverSns(List<String> deliverSns);
    ...
    @Query(value = "select count(distinct(box_number)) as box_count,count(imei) as imei_count, DATE_FORMAT(put_storage_time,'%Y-%m-%d') as put_storage_time,sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count from t_device_inventory where if(?1 is null or ?1='', 1=1, devtype=?1) and storehouse_id <>1 group by DATE_FORMAT(put_storage_time,'%Y-%m-%d')", nativeQuery = true)
     List<Map<String, Object>> putStorageStatistic(String devType, Pageable pageable);
    ...
    @Query(value = "select count(distinct(box_number)) as box_count,count(imei) as imei_count, DATE_FORMAT(put_storage_time,'%Y-%m-%d') as put_storage_time,sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count from t_device_inventory where operator_id in (?1) and if(?2 is null or ?2='', 1=1, devtype=?2) and storehouse_id <>1 group by DATE_FORMAT(put_storage_time,'%Y-%m-%d')", nativeQuery = true)
     List<Map<String, Object>> putStorageStatistic(List<Integer> operatorIds, String devType, Pageable pageable);
    ...
    @Query(value = "select count(distinct(box_number)) as box_count,count(imei) as imei_count, DATE_FORMAT(put_storage_time,'%Y-%m-%d') as put_storage_time,sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count from t_device_inventory where put_storage_time between ?1 and ?2 and if(?3 is null or ?3='', 1=1, devtype=?3) and storehouse_id <>1 group by DATE_FORMAT(put_storage_time,'%Y-%m-%d')", nativeQuery = true)
     List<Map<String, Object>> putStorageStatistic(Date startTime, Date endTime, String devType, Pageable pageable);
    ...
    @Query(value = "select count(distinct(box_number)) as box_count,count(imei) as imei_count, DATE_FORMAT(put_storage_time,'%Y-%m-%d') as put_storage_time,sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count from t_device_inventory where put_storage_time between ?1 and ?2 and t.operator_id in (?3) and if(?4 is null or ?4='', 1=1, devtype=?4) and storehouse_id <>1 group by DATE_FORMAT(put_storage_time,'%Y-%m-%d')", nativeQuery = true)
     List<Map<String, Object>> putStorageStatistic(Date startTime, Date endTime, List<Integer> operatorIds, String devType, Pageable pageable);
    ...
    @Query(value = "select put_storage_user_id, box_number, count(imei) as total_count, isp from t_device_inventory where put_storage_time between ?1 and ?2 group by box_number", nativeQuery = true)
     List<Map<String, Object>> getBoxNumberByPutStorageTime(Date start, Date end);
    ...
    @Query(value = "select put_storage_user_id, box_number, count(imei) as total_count, isp from t_device_inventory where put_storage_time between ?1 and ?2 and operator_id in (?3) group by box_number", nativeQuery = true)
     List<Map<String, Object>> getBoxNumberByPutStorageTime(Date start, Date end, List<Integer> operatorIds);
    ...
    @Query(value = "select distinct(box_number), count(imei) as total_count, isp from t_device_inventory where install_site_id is not null and devstate <> 1 group by box_number", nativeQuery = true)
     List<Map<String, Object>> getBackOffBoxNumbers();
    ...
    @Query(value = "select distinct(box_number), count(imei) as total_count, isp from t_device_inventory where install_site_id is not null and devstate <> 1 and operator_id in (?1) group by box_number", nativeQuery = true)
     List<Map<String, Object>> getBackOffBoxNumbers(List<Integer> operatorIds);
    ...
    @Query(value = "select imei from t_device_inventory where install_site_id is not null and devstate <> 1 and storehouse_id <> 1 and box_number in (?1)", nativeQuery = true)
     List<String> getBackOffImeisByBoxNumbers(List<String> boxNumber);
    /**
     * 根据箱号获取安装点及设备数量
     */
    @Query(value = "select install_site_id, count(imei) from t_device_inventory where box_number=?1 group by install_site_id", nativeQuery = true)
     List<Map<String, Object>> getInstallSiteAndCountByBoxNumber(String boxNumber);
    ...
    @Query(value = "select count(imei) as counts, isp from t_device_inventory where operator_id in (?1) and storehouse_id <> 1 and install_site_id is null group by isp", nativeQuery = true)
     List<Map<String, Object>> getUndispacheDeviceCountOfIsp(List<Integer> operatorIds);
    ...
    @Query(value = "select count(imei) as counts, isp from t_device_inventory where storehouse_id <> 1 and install_site_id is null group by isp", nativeQuery = true)
     List<Map<String, Object>> getUndispacheDeviceCountOfIsp();
    ...
    @Query(value = "select count(1) from t_device_inventory where operator_id in (?1)", nativeQuery = true)
     Long getDeviceNumByOperatorIds(List<Integer> ids);
    ...
    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count,"
            + "sum(if(isp='CUCC', 1,0)) as cucc_count, dispatch_time from t_device_inventory where if(?1 is null or ?1='', 1=1, devtype=?1) and day(dispatch_time) is not null group by day(dispatch_time), install_site_id", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(String devType, Pageable pageable);

    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count,"
            + "sum(if(isp='CUCC', 1,0)) as cucc_count, dispatch_time from t_device_inventory where operator_id in (?1) and if(?2 is null or ?2='', 1=1, devtype=?2) and day(dispatch_time) is not null group by day(dispatch_time), install_site_id", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(List<Integer> operatorIds, String devType, Pageable pageable);

    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count,"
            + "sum(if(isp='CUCC', 1,0)) as cucc_count, dispatch_time from t_device_inventory where install_site_name like %?1% and if(?2 is null or ?2='', 1=1, devtype=?2) and day(dispatch_time) is not null group by day(dispatch_time), install_site_id ", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(String installSiteName, String devType, Pageable pageable);

    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count,"
            + "sum(if(isp='CUCC', 1,0)) as cucc_count, dispatch_time from t_device_inventory where install_site_name like %?1% and operator_id in (?2) and if(?3 is null or ?3='', 1=1, devtype=?3) and day(dispatch_time) is not null group by day(dispatch_time), install_site_id", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(String installSiteName, List<Integer> operatorIds, String devType, Pageable pageable);

    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count,"
            + "sum(if(isp='CUCC', 1,0)) as cucc_count, dispatch_time from t_device_inventory where dispatch_time between ?1 and ?2 and if(?3 is null or ?3='', 1=1, devtype=?3) and day(dispatch_time) is not null group by day(dispatch_time), install_site_id", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(Date startTime, Date endTime, String devType, Pageable pageable);

    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count, "
            + "sum(if(isp='CUCC', 1,0)) as cucc_count, dispatch_time from t_device_inventory where dispatch_time between ?1 and ?2 and operator_id in (?3) and if(?4 is null or ?4='', 1=1, devtype=?4) and day(dispatch_time) is not null  group by day(dispatch_time), install_site_id", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(Date startTime, Date endTime, List<Integer> operatorIds, String devType, Pageable pageable);
    ...
    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count,"
            ...
            + "and day(dispatch_time) is not null group by day(dispatch_time), install_site_id", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(String installSiteName, Date startTime, Date endTime, String devType, Pageable pageable);
    ...
    @Query(value = "select install_site_id, install_site_name, count(imei) as total_count, sum(if(isp='CT', 1,0)) as ct_count, sum(if(isp='CMCC', 1,0)) as cmcc_count,"
            ...
            + "and day(dispatch_time) is not null group by day(dispatch_time), install_site_id", nativeQuery = true)
     List<Map<String, Object>> dispatchStatistic(String installSiteName, Date startTime, Date endTime, List<Integer> operatorIds, String devType, Pageable pageable);
    ...
    @Query(value = "select TIS.name, count(TE.imei) as totals, sum(if(TDI.isp='CT', 1,0)) as CTcount, sum(if(TDI.isp='CMCC', 1,0)) as CMCCcount from t_electrmobile TE left join nbiot_device_rt_data NDRT on TE.imei=NDRT.imei inner join t_device_inventory TDI on TDI.imei=TE.imei left join t_install_site TIS on TIS.install_site_id=TDI.install_site_id where NDRT.imei is null group by TDI.install_site_id order by totals desc", nativeQuery = true)
     List<Map<String, Object>> countHistoryInstalledUnormalCount();

    @Query(value = "select TIS.name, count(TE.imei) as totals, sum(if(TDI.isp='CT', 1,0)) as CTcount, sum(if(TDI.isp='CMCC', 1,0)) as CMCCcount from t_electrmobile TE left join nbiot_device_rt_data NDRT on TE.imei=NDRT.imei inner join t_device_inventory TDI on TDI.imei=TE.imei left join t_install_site TIS on TIS.install_site_id=TDI.install_site_id where NDRT.imei is null and TDI.operator_id in (?1) group by TDI.install_site_id order by totals desc", nativeQuery = true)
     List<Map<String, Object>> countHistoryInstalledUnormalCount(List<Integer> operatorIds);
    ...
    @Query(value = "select e.create_time as time, count(e.imei) as counts from t_electrmobile e where datediff(now(),e.create_time) <= ?1 group by day(e.create_time)", nativeQuery = true)
     List<Map<String, Object>> countHistoryInstalledByOffset(Integer offset);
    ...
    @Query(value = "select e.create_time as time, count(e.imei) as counts from t_electrmobile e where datediff(now(),e.create_time) <= ?1 and e.operator_id in (?2) group by day(e.create_time)", nativeQuery = true)
     List<Map<String, Object>> countHistoryInstalledByOffset(Integer offset, List<Integer> operatorIds);
    ...
    @Query(value = "select count(1) from t_device_inventory where group_id in (?1)", nativeQuery = true)
    ...
    @Query(value = "select * from t_device_inventory where group_id = ?1", nativeQuery = true)
     List<TdeviceInventory> findByGroupId(Integer groupId);

    @Query(value = "select count(1) from t_device_inventory where storehouse_id = ?1", nativeQuery = true)
     Long countByStoreHouseId(Integer storehouseId);
    ...
    @Query(value = "select TDI.box_number, count(TDI.imei) as totalCount, isp, storehouse_name from t_device_inventory TDI left join t_device_storehouse TDS "
            + "on TDI.storehouse_id=TDS.id where TDI.install_site_id is null and TDS.id <> 1 group by TDI.box_number", nativeQuery = true)
    List<Map<String, Object>> getDispatchBoxNumbers();
...
//    List<Map<String, Object>> getDispatchBoxNumbers(List<Integer> operatorIds);
     ...
     */
    @Query(value = "select count(1) from t_device_inventory where operator_id in (?1) and devstate <> 0 and storehouse_id <> 1 and imei not in (?2)", nativeQuery = true)
    Integer countSellCountByOperatorIds(List<Integer> operatorIds, List<String> imeis);

    @Query(value = "select count(1) from t_device_inventory where operator_id in (?1) and devstate <> 0 and storehouse_id <> 1", nativeQuery = true)
    Integer countSellCountByOperatorIds(List<Integer> operatorIds);

    @Query(value="select count(1) from t_device_inventory where operator_id in (?1) and storehouse_id <> 1 and imei not in (?2)", nativeQuery = true)
    Integer countAllStoreCountByOperatorIds(List<Integer> operatorIds, List<String> imeis);

    @Query(value="select count(1) from t_device_inventory where operator_id in (?1) and storehouse_id <> 1", nativeQuery = true)
    Integer countAllStoreCountByOperatorIds(List<Integer> operatorIds);

    @Query(value = "select count(1) from t_device_inventory where operator_id in (?1) and devstate = 1", nativeQuery = true)
    ...
    Page<TdeviceInventory> getBoxNumbersOfPutStorage(String boxNumber, String storehouseName, String operatorName, List<Integer> operatorIds, Integer isPutStorage, Pageable pageable);
    ...
    Page<TdeviceInventory> getBoxNumbersOfPutStorage(String boxNumber, String operatorName, List<Integer> operatorIds, Pageable pageable);
    ...
    Page<TdeviceInventory> getBoxNumbersOfPutStorage(String boxNumber, String operatorName, Integer isPutStorage, Pageable pageable);

    @Query(value = "select * from t_device_inventory where if(?1 is null or ?1='', 1=1, box_number = ?1) " +
            "and if(?2 is null or ?2='', 1=1, operator_name like %?2%) and box_number is not null group by box_number", nativeQuery = true)
    Page<TdeviceInventory> getBoxNumbersOfPutStorage(String boxNumber, String operatorName, Pageable pageable);
    ...
    @Query(value = "select distinct (box_number) from t_device_inventory where box_number in (?1) and devstate = ?2", nativeQuery = true)
    List<String> findByBoxNumberAndDevState(List<String> boxNumbers, int devstate);

    @Query(value="select distinct(install_site_id) from t_device_inventory where box_number =?1 and install_site_id is not null", nativeQuery = true)
    List<Integer> countInstallSiteIdByBoxNumber(String boxNumber);

    @Query(value="select distinct(d.deliver_sn) as ddeliver_sn, d.* from t_device_inventory d where d.storehouse_id = 1 group by ddeliver_sn", nativeQuery = true)
    List<Map<String, Object>> getDeliverSns();

    @Query(value="select distinct(d.deliver_sn) as ddeliver_sn, d.* from t_device_inventory d where d.storehouse_id = 1 and d.operator_id in (?1) group by ddeliver_sn", nativeQuery = true)
    List<Map<String, Object>> getDeliverSns(List<Integer> operatorIds);

    @Query(value = "select * from t_device_inventory where devstate=1", nativeQuery = true)
    List<TdeviceInventory> getAllInstalledDevices();

    @Modifying
    @Query(value="update t_device_inventory set storehouse_id = 1, storehouse_name='华强仓库', is_active=true, install_site_id=null, install_site_name=null, put_storage_time=null, put_storage_user_id=null where imei in (?1)", nativeQuery = true)
    Integer updateStorehouseToHQByImeis(List<String> imeis);
}
